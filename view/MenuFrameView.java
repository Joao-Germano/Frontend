...
public class MenuFrameView extends JFrame {
    ...
    public MenuFrameView() {
        ...
        cadastrarMenu.addActionListener(
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    setVisible(false);
                    NovoCadastroView appNovoCadastroView = new NovoCadastroView();
    ...
    //Adicionar 
        ...
        Icon logoPerferctBurguer = new ImageIcon (getClass().getResource("logo-perfect-burguer.jpg"));
        add(new JLabel(logoPerferctBurguer));
        setSize(500,500);
        setVisible(true);
     
        lblNotificacoes = new JLabel();
        lblNotificacoes.setText("Notificações");
       // lblNotificacoes.setHorizontalAlignment(SwingConstants.SOUTH);
